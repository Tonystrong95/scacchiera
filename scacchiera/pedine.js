...
// tranne il cavallo
//
export function mosseLegaliRe(pos) {
  let prima = prossimaPosizione(pos, -1, 1)
  let seconda = prossimaPosizione(pos, 0, 1)
  let terza = prossimaPosizione(pos, 1, 1)
  let quarta = prossimaPosizione(pos, -1, 0)
  let quinta = prossimaPosizione(pos, 1, 0)
  let sesta = prossimaPosizione(pos, -1, -1)
  let settima = prossimaPosizione(pos, 0, -1)
  let ottava = prossimaPosizione(pos, 1, -1)
